        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Model: {availableModels.find(m => m.value === selectedModel)?.label}
            ...
            <div className="text-center py-8">
              <div className="p-4 bg-gray-800/30 rounded-lg border border-gray-700/50 max-w-md mx-auto">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  {isSearchMode ? ' OSDR search mode is enabled.' : ' Switch to search mode for OSDR queries.'}
                </p>
              </div>
            </div>
          )}
              ...
              <div className="bg-gray-800/60 border border-gray-700/30 rounded-2xl px-4 py-3 max-w-[85%]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-400">
                    AI is thinking... (using {availableModels.find(m => m.value === selectedModel)?.label})
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="p-4 border-t border-gray-700/50 bg-gray-800/20">
        <form onSubmit={handleSubmit} className="flex gap-3">
          <div className="flex-1 relative">
            <Input
              ...
              placeholder={isSearchMode ? "Search OSDR database..." : "Type your message..."}
              disabled={isLoading}
        ...
        <div className="flex items-center gap-2 mt-2">
          <span className="text-xs text-gray-500">
            Using {availableModels.find(m => m.value === selectedModel)?.label}
          </span>
          {isSearchMode && (
