            ...
            >
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    console.log("Preview button clicked with sessionId:", sessionId);
                    
                    // Safety check - don't proceed if sessionId is empty
                    if (!sessionId) {
                      console.error("ERROR: Session ID is empty! Cannot preview table.");
                      alert("Cannot preview table: missing session ID. Please try uploading the file again.");
                      return;
                    }
