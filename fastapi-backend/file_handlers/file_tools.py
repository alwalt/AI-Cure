...
@router.get("/api/get_plot/{filename}")
async def get_plot(filename: str):
    """Serve plot files generated by MCP viz tools from the plots directory.

    Looks under either the environment variable OSDR_PLOTS_DIR or defaults to
    fastapi-backend/plots relative to this file.
    """
